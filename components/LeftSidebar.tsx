...
const LeftSidebar = () => {
  ...
  return (
    ...
    <section className="left-sidebar text-white bg-slate-900">
    <nav className="flex flex-col gap-6" >
      <Link href= "/" className="flex cursor-pointer items-center gap-1 pb-10 max-lg:justify-center">
        <Image  src= "/icons/deen.jpg" alt="logo" width={23} height={27} />
        <h1 className= "text-24 font-extrabold text-white-1 max-lg:hidden">DeenApp</h1>
